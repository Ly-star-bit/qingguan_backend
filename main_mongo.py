...
from app.qingguan.apis.web_vba_mongo import web_vba_router,IPWhitelistMiddleware
...
from app.apis.excel_preview import router as excel_preview_router, mount_static_files
from fastapi.middleware.cors import CORSMiddleware

from app.db_mongo import enforcer
from app.middleware import AccessTokenAuthMiddleware, BasicAuth,AuthenticationMiddleware
...
def start_nextjs():
    ...
    # 启动 Next.js 应用
    process = subprocess.Popen(['next', 'start', '-H', '0.0.0.0'], cwd=r"D:\react_python\dadan\front", shell=True)
    return process
@asynccontextmanager
