...
class MoreLinkClient:
    ...
    def check_and_use_local_session(self):
        ...
        if client:
            resp = client.post("https://morelink56.com/Common/IDATA?type=fun&proc=bll.RBTool.QueryFreightPolicyList",timeout=30)
    ...
    def login_morelink_get_httpx_client(self,retry_counts:int=5):
        ...
        res = client.post("https://morelink56.com/Login/index",timeout=30)
        ...
        if login_resp_data['success'] == True:
            ...
            logger.error("登陆失败")
            return None
    def dahuodingdan_all_data(self,start_date_str:str=None,end_date_str:str=None):
        """获取最近1个月的大货订单的数据
        ...
        if response.status_code == 200:
            ...
            return None  
    def dahuodingdan_worknum_search_httpx(self, numberno: str, signtype: str):
    ...
    def cooperate_client_search(self):
        ...
        client = self.httpx_client
        cooperate_client_res = client.post(url=cooperate_client_url,timeout=30)
    ...
    def fba_warehouse_search(self):
        ...
        fba_warehouse_res = client.post(url=fba_warehoust_url,timeout=30)
        if fba_warehouse_res.status_code == 200:
            return fba_warehouse_res.json()
