...
from rpa_tools.utils.morelink_upload_api import (
    get_all_channelid,
    ...
    for order in orders:
        try:
            ...
            if send_customer and (send_thing_remarks or sender or phone):
                ...
                if send_customer=='HKLMT-香港兰玛特-SZ'  and upload_payload['fbano'] and 'FBA' in upload_payload['fbano']:
                    upload_payload["pushamazon"] = '1'
